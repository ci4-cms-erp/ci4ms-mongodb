    ...
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="<?= (!empty($settings->templateInfos->widgets->sidebar)) ? 'col-md-9' : 'col-md-12' ?>">
                ...
                <hr>
                <!-- Comments section TODO: kodlanacak.-->
                <section>
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <form class="mb-4 row">
                                ...
                                <div class="col-12 form-group text-end">
                                    <button class="btn btn-primary btn-sm sendComment" type="button" data-id=""
                                            data-blogid="<?= (string)$infos->_id ?>">Send
                                    </button>
                                </div>
                            </form>
                            <?php if (!empty($comments)) { ?>
                                <hr>
                                <div id="comments">
                                    <?php echo comments($comments, $infos->_id); ?>
                                </div>
                                <div class="d-flex">
                                    <div class="w-100">
                                        <button class="btn btn-warning w-100" onclick="loadMore('<?=(string)$infos->_id?>')" id="loadMore" data-skip="5" data-defskip="5"><i class=""></i> Load More</button>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
