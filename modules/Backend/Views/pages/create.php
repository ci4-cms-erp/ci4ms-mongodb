            ...
            <form action="<?= route_to('pageCreate') ?>" class="form-row" method="post">
                ...
                <div class="col-md-8 form-group row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="title" class="form-control ptitle" placeholder="Sayfa Başlığı" required>
                    </div>
                    <div class="form-group col-md-12">
...
<script>
    ...
    $('.ptitle').on('change',function () {
        $.post('<?=route_to('checkSeflink')?>',{"<?=csrf_token()?>": "<?=csrf_hash()?>",'makeSeflink':$(this).val(),'where':'page'},'json').done(function (data) {
